...
# - A is the particle starting from left, and B is the particle starting on the right side!
...
def One_D_random_walk_Match(start_pos_A, start_pos_B, prob_left_A, prob_left_B, prob_not_moving_A = 0, prob_not_moving_B = 0):
    ...
    ###  This was used to return steps for prediciton. Keeping this line uncommented moves on 
