...
def One_D_random_walk_Match(start_pos_A, start_pos_B, prob_left_A, prob_left_B, prob_not_moving_A=0, prob_not_moving_B=0):
    ...
    move_step_A, probabilities_A = [-1, 0,
                                    1], [prob_left_A, prob_not_moving_A, prob_right_A]
    move_step_B, probabilities_B = [-1, 0,
                                    1], [prob_left_B, prob_not_moving_B, prob_right_B]
